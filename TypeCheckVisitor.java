...
public class TypeCheckVisitor implements ASTVisitor {
	...
	public Object visitBinaryChain(BinaryChain binaryChain, Object arg) throws Exception {
		...
		if(binaryChain.getE0().getTypeName() == URL && binaryChain.getE1().getTypeName() == IMAGE &&
			...
			binaryChain.setTypeName(IMAGE);
		else if(binaryChain.getE0().getTypeName() == IMAGE && binaryChain.getE1() instanceof IdentChain && binaryChain.getE1().getTypeName() == IMAGE &&
				binaryChain.getArrow().isKind(ARROW))
			binaryChain.setTypeName(IMAGE);
		else if(binaryChain.getE0().getTypeName() == INTEGER && binaryChain.getE1() instanceof IdentChain && binaryChain.getE1().getTypeName() == INTEGER &&
				binaryChain.getArrow().isKind(ARROW))
			binaryChain.setTypeName(INTEGER);
		else
	...
	public Object visitBinaryExpression(BinaryExpression binaryExpression, Object arg) throws Exception {
		...
		if(binaryExpression.getE0().getTypeName() == INTEGER && binaryExpression.getE1().getTypeName() == INTEGER &&
				binaryExpression.getOp().isKind(PLUS, MINUS, TIMES, DIV, MOD))
			...
			binaryExpression.setTypeName(IMAGE);
				...
				binaryExpression.getOp().isKind(TIMES, DIV, MOD))
			binaryExpression.setTypeName(IMAGE);
			...
			binaryExpression.setTypeName(BOOLEAN);
				...
				binaryExpression.getOp().isKind(LT, GT, LE, GE, AND, OR))
			binaryExpression.setTypeName(BOOLEAN);
